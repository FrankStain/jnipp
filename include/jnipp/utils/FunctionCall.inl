...
namespace utils
{
	...
	template< typename TNativeReturnType, typename... TNativeArguments >
	inline TNativeReturnType FunctionCall<TNativeReturnType, TNativeArguments>::Call( TNativeArguments... arguments ) const
	{
		...
		auto function_result = reinterpret_cast<JavaType>(
			(m_local_env->*FUNCTION_HANDLER)( m_object_ref, m_function_id, jnipp::marshaling::ToJava( std::forward<TNativeArguments>( arguments ) )... );
		);
	...
	template< typename TNativeReturnType, typename... TNativeArguments >
	inline TNativeReturnType FunctionCall<TNativeReturnType, TNativeArguments>::CallNonVirtual( TNativeArguments... arguments ) const
	{
		constexpr const size_t LOCAL_FRAME_SIZE = TotalLocalFrame<TNativeReturnType, TNativeArguments...>::RESULT;
		...
		auto function_result = reinterpret_cast<JavaType>(
			(m_local_env->*NONVIRTUAL_FUNCTION_HANDLER)( m_object_ref, m_function_id, jnipp::marshaling::ToJava( std::forward<TNativeArguments>( arguments ) )... );
		);
	...
	template< typename... TNativeArguments >
	inline void FunctionCall<void, TNativeArguments>::Call( TNativeArguments... arguments ) const
	{
	...
	template< typename... TNativeArguments >
	inline void FunctionCall<void, TNativeArguments>::CallNonVirtual( TNativeArguments... arguments ) const
	{
		constexpr const size_t LOCAL_FRAME_SIZE = TotalLocalFrame<TNativeArguments...>::RESULT;
